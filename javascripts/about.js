(function(window, document, undefined) {
	...
	var aboutTemplate = [
		...
		'<p>If you are interested in participating in the club, please consider joining our mailing list <a href="#call-to-action">below</a>. A sampling of our work can be found on our <a href="www.stanfordsportsanalytics.wordpress.com">blog</a>. Our social media presence includes a <a href="www.twitter.com/stanfordsac">Twitter</a> account and a <a href="www.facebook.com/stanfordsportsanalytics">Facebook</a> account. These accounts will both be updated with information regularly during the school year.</p>'
	].join('\n');
