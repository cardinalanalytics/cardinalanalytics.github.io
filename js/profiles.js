	...
	var membersData = {
		...
		members: [
			...
			},
			{
				...
				joined: '2022',
				image: 'images/profiles/Obinna.jpg',
		...
		members_hide: [
			{	name: 'Yasi Khan',
				...
				description: "asi served as Co-President. She majored in Symbolic Systems on the Human-Centered Artificial Intelligence (HAI) track, while also minoring in creative writing (poetry). She formerly served as the vice president as well as the lead of the club's baseball project.",
				id: "yasi",
			},
			{	name: 'Max Pike',
				position: 'Co-President',
